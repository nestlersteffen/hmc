...
#' Obtain samples from a NUTS-chain with all subroutines implemented in R
#'
...
nuts_chain_r <- function( model_fn=NULL, args=NULL, verbose=FALSE, inits=NULL,find_epsilon=TRUE )
{
